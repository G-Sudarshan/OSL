...
void priority_non_premptive(Process p[],int n);
...
int main()
{
	...
	int i, j, n, tq;
   	...
   	for(i=0; i<n; i++) {
		...
		p[i].shortest_time=p[i].is_completed=0;
...
void priority_non_premptive(Process p[],int n)
{
	/*int i,avgwt=0,avgtt=0,currenttime=0,completed=0,prev=0;
